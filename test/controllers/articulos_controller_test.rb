...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { contenido: @articulo.contenido, titulo: @articulo.titulo } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { contenido: @articulo.contenido, titulo: @articulo.titulo } }
