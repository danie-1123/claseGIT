...
class ProfesoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesores_url, params: { profesor: { apellido: @profesor.apellido, cedula: @profesor.cedula, nombre: @profesor.nombre, telefono: @profesor.telefono, user_id: @profesor.user_id } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { apellido: @profesor.apellido, cedula: @profesor.cedula, nombre: @profesor.nombre, telefono: @profesor.telefono, user_id: @profesor.user_id } }
